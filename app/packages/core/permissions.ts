 ...
 * @param equals Determines to include if the permission is equal to the target role, defaults to false
 ...
 */
export function rankApplicationRoles(currentRole: ApplicationRoles, targetRole?: ApplicationRoles, equals: boolean = false) {
    if (targetRole && !equals) {
