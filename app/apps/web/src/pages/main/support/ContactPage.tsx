      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="mb-20">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <h2 className="text-3rd font-semibold text-foreground text-3xl">What can we help you with?</h2>
        ...
        <div className="rounded-3xl border border-border/80 bg-background/60 p-10 text-center backdrop-blur">
        ...
        {/* Optional CTA block if you want it later
        <div className="mt-16 rounded-3xl border border-primary/30 bg-primary/10 px-10 py-12 text-center backdrop-blur">
