...
import { TabsComponentProps } from "./ProfilePage"
...
function formatPasskeyCreatedAt(createdAt?: Date | string | null) {
  if (!createdAt) {
    return "Unknown"
  }
  const normalizedDate = typeof createdAt === "string" ? new Date(createdAt) : createdAt
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">
                      Added on {formatPasskeyCreatedAt(passkey.createdAt)}
                    </p>
                  </div>
                </div>
                <Button 
